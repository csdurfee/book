...
def superfade(eliminate_top=5, lower_thresh=49, upper_thresh=60, base_picks=None, ats_record=None, dir='sbr'):
    """
    ...
    ## new sttrategy: don't bet against top 3 teams by record ats, on this day.
    good_picks = []
    # the problem is here. we need to pass in the max dates in base picks to get_ats_for_range
    ...
    if ats_record is not None:
        ...
        ats_by_date = scrape_sbr.get_ats_for_range(start=min_date, end=max_date, dir=dir) 
    # fixme: this isn't ideal, we're getting days we don't need to 
    prev_day = None
